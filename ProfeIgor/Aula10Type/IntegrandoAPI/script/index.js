"use strict";
const APIKEY = "https://dynamic-events-api.onrender.com/api";
;
let allPrograms = [];
async function searchAllPrograms() {
    try {
        ...
        allPrograms = programsConverted.sort((a, b) => Number(b.destaque) - Number(a.destaque));
...
function renderAllPrograms(programs) {
    let html = "";
    const programsList = document.getElementById("listaProgramas");

const createTask = (event) =>{
    ...
    Para que isso funcione, precisamos passar o document.createElement('li'). Nós colocaremos essa expressão dentro de uma variavel que ficará com a seguinte estrutura: const tarefa = document.createElement() */

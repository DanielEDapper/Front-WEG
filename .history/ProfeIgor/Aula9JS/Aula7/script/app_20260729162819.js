...
/* Exemplo: Aconteceu um evento classico no refeitorio da fábrica no horario de maior volume, um operador fez um pedido de um prato sob modeda no balcão. A atendente registrou a ficha e entregou a ele um bip eletronico(ou senha). O operador não ficou parado no balcao travando a fila a

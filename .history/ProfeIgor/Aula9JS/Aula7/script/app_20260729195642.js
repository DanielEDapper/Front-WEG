const cepInput = document.getElementsById("cep");
const cepInputValue = cepInput.value();

const searchCep = document.getElementById('enviar');
searchCep.addEventListener('click', buscaEndereco(cepInputValue));

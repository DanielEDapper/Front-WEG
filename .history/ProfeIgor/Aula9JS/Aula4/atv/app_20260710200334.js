...
console.log("Tamanho das frutas: ", tamanhosFrutas);

let frutasComMaisDe5Caracteres = frutas.filter(fruta => fruta.length > 5);
console.log("Mais de 5 caracteres: ", frutasComMaisDe5Caracteres);

let numerosReduce = [10,20,30,40];
let somaReduce = numerosReduce.reduce((acumulador, valorAtual) => acumulador + valorAtual, 0);

...
O return funciona como a "porta de saída" da funçã. Ele para a execução do cloco e joga o valor gerado lá fora. Dessa forma, quem chamou a função pode "agarrar" esse valor e salva-lo */
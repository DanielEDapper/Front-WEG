...
/*  Exemplo:
    dataType001 que será o parametro(ou seja a gaveta vazia)
*/

let typeDataLearned = function(dataType001)
{
    console.log(`Nós aprendemos até aqui: ${dataType001}`);
}

//  Numbers é o argumento(o valor real que entra na )
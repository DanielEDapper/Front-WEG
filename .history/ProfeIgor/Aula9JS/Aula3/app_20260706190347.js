...
const maintenanceTag = `${allSensors[0].slice(0,2)}${allSensors[1].slice(4,6)}${allSensors[3].slice(6,8).replace("r", "t")}`;
// console.log(maintenanceTag);

let amperageValues = [2,4,6];
console.log(amperageValues[1] **3);
amperageValues[1] += 4;
console.log(amperageValues[1] **);
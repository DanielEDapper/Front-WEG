...
async function searchWeatherByCity(city)
{
    ...
    try{
        ...
        temperature.textContent = `${Math.rsearchWeatherConverted.main.temp}°C`;
        city.textContent = searchWeatherConverted.name;
        description.textContent = searchWeatherConverted.weather.description;
        humidity.textContent = searchWeatherConverted.main.humidity;
        wind.textContent = searchWeatherConverted.wind.speed;

...
function ListarTarefas()
{
    ...
    return(
        <div className="lista-container">
            <h3 className="lista-texto">Buscador de Tarefas</h3>
            <input type="text" 
            ...
            {tarefasFiltradas.length === 0 ? (
                <p>
                    <em>Nenhuma tarefa encontrada com esse nome.</em>
                </p>
            ) : <ul className="lista-ul">
                {tarefasFiltradas.map((tarefa) => (
                    <li key={tarefa.id} className="item-usuario">
                        <strong>{tarefa.title} - {tarefa.completed}</strong>
                        <br />

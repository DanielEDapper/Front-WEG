...
function FormularioTarefa({onAdicionarTarefa} : FormularioProps)
{
    ...
    if (texto === '') return; // valida não-vazio

    onAdicionarTarefa(texto); // dispara callback pro pai
    setTextoTerefa('');       // limpa o input
  }
    ...
    return(
        <div className="form-container">
            ...
            <button className="form-btn" onClick={}>Cadastrar Tarefa</button>
        </div>
    );
}

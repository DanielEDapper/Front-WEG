...
function adicionarProduto(product: Produto):void {
    produtos.push(product);
}

function listarProdutos(produtos: Produto[]): number
{
    ...
    produtos.forEach(product => {
        ...
        console.log("-------------------------")
        valorTotalEstoque += product.price * product.total;;
    });
...
const name: string = prompt("Digite o nome do produto: ") ?? "";
const price: string = prompt("Digite o valor do produto:") ?? "";
const brand: string = prompt("Digite a marca do produto: ") ?? "";
const total: string = prompt("Digite a quantidade do produto:") ?? "";
...
const valorTotalEstoque = listarProdutos(produtos);
console.log(`Valor Total Estoque: ${valorTotalEstoque}`)
...
//Se uma função serve apenas para executar uma ação (tipo imprimir algo no console ou salvar algo no banco de dados e não devolve nenhum valor com o return, dizemos que o retorno dela é void ())